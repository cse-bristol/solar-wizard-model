...
from solar_model.solar_pv.constants import FLAT_ROOF_AZIMUTH_ALIGNMENT_THRESHOLD
from solar_model.solar_pv.roof_polygons.roof_polygons import _building_orientations, \
