...
from solar_model.db_funcs import connection, sql_command, connect
from solar_model.geos import azimuth, square, largest_polygon
from solar_model.solar_pv.constants import FLAT_ROOF_DEGREES_THRESHOLD, \
    FLAT_ROOF_AZIMUTH_ALIGNMENT_THRESHOLD, AZIMUTH_ALIGNMENT_THRESHOLD
from solar_model.solar_pv.roof_polygons.roof_polygon_archetypes import \
