...
from solar_pv.lidar.en_to_grid_ref import en_to_grid_ref, round_down_to, \
    is_in_range
...
class EnToGridRefTest(ParameterisedTestCase):
    ...
    def test_en_to_grid_ref(self):
        self.parameterised_test([
            ...
            # without quadrants
            (50000, 40000, 1000, 'SV5040'),
            (90000, 90000, 1000, 'SV9090'),
            (5000, 0, 1000, 'SV0500'),
            (5000, 5000, 1000, 'SV0505'),
            (0, 5000, 1000, 'SV0005'),
            (460726, 210585, 1000, 'SP6010'),
            (465726, 210585, 1000, 'SP6510'),
            (465726, 215585, 1000, 'SP6515'),
            (460726, 215585, 1000, 'SP6015'),
