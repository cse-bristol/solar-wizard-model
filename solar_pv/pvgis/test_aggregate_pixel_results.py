...
class PixelAggregateTestCase(ParameterisedTestCase):
    ...
    def test_pixel_aggregation(self):
        ...
        self.parameterised_test([
            ('osgb1000008955040.json', 43989, 'kwh_year_avg', 3527.02),
            ('osgb1000008955040.json', 43989, 'kwh_m01_avg', 118.76),
            ('osgb1000008955040.json', 43989, 'kwh_m06_avg', 459.72),
            ('osgb1000008955040.json', 43989, 'horizon', [0.06, 0.16, 0.24, 0.36, 0.37, 0.39, 0.49, 0.5, 0.49, 0.49, 0.5, 0.5, 0.41, 0.41, 0.38, 0.26, 0.25, 0.16, 0.08, 0.07, 0.06, 0.03, 0.06, 0.03, 0.02, 0.01, 0.0, 0.01, 0.0, 0.0, 0.01, 0.0, 0.0, 0.04, 0.05, 0.03]),
        ], _roof_field)
