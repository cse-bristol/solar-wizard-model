...
from albion_models.solar_pv.pvgis.dev_aggregate_pixel_results import RASTER_TABLES
...
class PixelAggregateTestCase(ParameterisedTestCase):
    ...
    def test_pixel_aggregation(self):
        ...
        self.parameterised_test([
            ('osgb1000014995063.json', 8075, 'kwh_year', 256.655),
            ('osgb1000014995063.json', 8075, 'kwh_m01', 5.327),
            ('osgb1000014995063.json', 8075, 'kwh_m06', 38.079),
