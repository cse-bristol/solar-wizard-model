...
def pvgis(pg_uri: str,
     ...
     * finally the post-load script will need to also go from pixel-level facts about kWh
...
def _write_results_to_db(pg_conn, job_id: int, solar_dir: str, kwh_raster: str, debug_mode: bool):
    ...
    #    but it would be good to know they're still being applied to the total.
