...
from albion_models.solar_pv.rasters import create_elevation_override_raster

_TEST_ELEVATION_RASTER: str = os.path.realpath("../../testdata/solar_pv/rasters/inputs/elevation_4326.tif")
